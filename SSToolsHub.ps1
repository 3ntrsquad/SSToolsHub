...
$global:installDir = "$env:USERPROFILE\Downloads\SSToolsHub"
$global:logPath = Join-Path $env:TEMP "sstools_hub.log"
$global:window = $null
$global:bgTimer = $null
...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        ...
        Title="SS Tools Hub" Width="1440" Height="900"
                ...
                <Border Grid.Row="0" Background="#0F0F1A" BorderBrush="#2A2A40" BorderThickness="0,0,0,1">
                    <Grid Margin="16,0">
                        ...
                        <StackPanel Grid.Column="1" Orientation="Horizontal" VerticalAlignment="Center">
                            ...
                            <Button x:Name="ClearCacheBtn" Content="🗑" Style="{StaticResource TitleBtn}" Margin="0,0,2,0"/>
                            <Button x:Name="OpenCmdBtn" Content=">_" Style="{StaticResource TitleBtn}" Margin="0,0,2,0"/>
                            <Button x:Name="MinBtn" Content="─" Style="{StaticResource TitleBtn}" Margin="0,0,0,0"/>
                            <Button x:Name="CloseBtn" Content="✕" Style="{StaticResource TitleBtn}" Foreground="#FF6B6B" Margin="4,0,0,0"/>
                        </StackPanel>
                    </Grid>
                </Border>
...
if ($global:window) {
    ...
    if ($global:OpenCmdBtn) {
        $global:OpenCmdBtn.Add_Click({
            ...
            try {
                Start-Process powershell.exe -ArgumentList "-NoExit", "-ExecutionPolicy", "Bypass", "-Command", "Write-Host 'SS Tools Hub PowerShell Console' -ForegroundColor Magenta; Write-Host 'Type your commands below:' -ForegroundColor Cyan"
